function buildBookingNotificationMessage(booking = {}) {
    const lines = [
        ...
        `Exact Pick-up Address: ${booking.pickup_location_address || '—'}`,
        `Pick-up Flight Number: ${booking.pickup_flight_number || '—'}`,
        `Return Location: ${booking.return_address || '—'}`,
        `Exact Return Address: ${booking.return_location_address || '—'}`,
        `Return Flight Number: ${booking.return_flight_number || '—'}`,
